defmodule RatchetWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(RatchetWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(RatchetWeb.Gettext, "errors", msg, opts)
    end
  end
